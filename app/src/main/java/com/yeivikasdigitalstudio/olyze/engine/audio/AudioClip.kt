package com.yeivikasdigitalstudio.olyze.engine.audio

import android.net.Uri

/**
 * Clip de audio de fondo del proyecto, en memoria (análogo a [com.yeivikasdigitalstudio.olyze.engine.scene.Layer]
