package com.yeivikasdigitalstudio.olyze.ui.theme
 ...
 * forma cíclica, según su [com.yeivikasdigitalstudio.olyze.engine.scene.Layer.colorIndex]
 ...
 * ([com.yeivikasdigitalstudio.olyze.engine.scene.Layer.useGradientColor]), esto
 ...
 * ([com.yeivikasdigitalstudio.olyze.engine.scene.Layer.customColorArgb]) sobre
 ...
 */
fun effectiveLayerColor(layer: com.yeivikasdigitalstudio.olyze.engine.scene.Layer): Color {
 ...
 */
fun effectiveLayerBrush(layer: com.yeivikasdigitalstudio.olyze.engine.scene.Layer): Brush {
    if (layer.useGradientColor) {
        val start = layer.customGradientStartArgb
        val end = layer.customGradientEndArgb
...
fun effectiveLayerColorStrong(layer: com.yeivikasdigitalstudio.olyze.engine.scene.Layer): Color =
