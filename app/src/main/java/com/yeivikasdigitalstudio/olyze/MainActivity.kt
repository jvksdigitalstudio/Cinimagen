package com.yeivikasdigitalstudio.olyze
...
import com.yeivikasdigitalstudio.olyze.ui.EditorScreen
import com.yeivikasdigitalstudio.olyze.ui.ProjectsScreen
import com.yeivikasdigitalstudio.olyze.ui.theme.OlyzeGradient
import com.yeivikasdigitalstudio.olyze.ui.theme.OlyzeTheme
import com.yeivikasdigitalstudio.olyze.viewmodel.EditorViewModel
import com.yeivikasdigitalstudio.olyze.viewmodel.EditorViewModelFactory
import com.yeivikasdigitalstudio.olyze.viewmodel.ProjectsViewModel
import com.yeivikasdigitalstudio.olyze.viewmodel.ProjectsViewModelFactory
import kotlinx.coroutines.launch

/** Mime type propio del archivo exportado ".omc" — también declarado en AndroidManifest.xml. */
private const val OMC_MIME_TYPE = "application/x-omc"
...
class MainActivity : ComponentActivity() {
    ...
    // Uri de un archivo ".omc" recibido desde AFUERA de la app —
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        com.yeivikasdigitalstudio.olyze.engine.render.DisplayRefreshRate.applyHighestRefreshRate(this)
        ...
        setContent {
            ...
            OlyzeTheme {
                ...
                Surface(
                    ...
                    // Importación de un ".omc" recibido de afuera: se
                    ...
                    LaunchedEffect(pendingImportUri) {
                        ...
                        if (importedId != null) {
                            ...
                            Toast.makeText(
                                this@MainActivity,
                                "Ese archivo no es un proyecto de Olyze Movie Creator válido (.omc)",
                                Toast.LENGTH_LONG
                            ).show()
                        }
                    }
