...
(`/Android/data/com.yeivikasdigitalstudio.olyze/files/exports/`), por lo
...
```
app/src/main/java/com/yeivikasdigitalstudio/olyze/
...
| Aplicación | **Olyze Movie Creator** (`com.yeivikasdigitalstudio.olyze`) |
| Motor tecnológico | **EliNer** — EliNer API · EliNer Engine · EliNer Render · EliNer Audio · EliNer Core |

El `namespace`/`applicationId` de la app es `com.yeivikasdigitalstudio.olyze`, definido en
...
módulo `:app`, bajo `com.yeivikasdigitalstudio.olyze.engine`. La migración de identidad
...
```
Olyze Movie Creator (YeiViKas Digital Studio)
│
